...
CH1_SCENE0_DATA = SceneData(
    ...
    initial_text=(
        ...
        "## 과학적 생존법\n"
        "---\n\n"
        "쿠당탕!! 엄청난 굉음과 함께 엉덩이에 전해지는 고통.\n"
        "눈을 떠보니 익숙한 랩실 천장이 아니라, 눈이 시릴 만큼 파란 하늘과 작열하는 태양이 보인다.\n\n"
        "\"...살아 있나?\"\n\n"
        "속이 울렁거린다. 옆에는 MK-II가 모래사장에 꼴사납게 처박혀 연기를 내뿜고 있다. "
        "주변은 온통 바다뿐이다. 덥다. 너무 덥다."
    ),
    initial_state={
    ...
    on_enter_actions=[
        ...
        Action(
            type=ActionType.PRINT_SYSTEM,
            value="<Tip> 체력이 0이 되면 이 지점에서 다시 시작합니다."
        )
    ],
            ...
            interactions=[
                Interaction(
                    actions=[
                        ...
                        Action(
                            type=ActionType.PRINT_SYSTEM,
                            value="[경고] 짠물을 마셔 체력이 10 감소했습니다. 잘못된 행동은 생명을 위협합니다."
                        )
                    ]
                )
            ]
